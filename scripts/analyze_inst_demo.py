        ...
        with open(fp,'r') as rf:
            ...
            for ln in lines:
                if 'INJ_HEAD' in ln and 'INJ_END' in ln:
                    ...
                    regs=info['regs']
                    reg_name=info['inst_type']
                    if reg_name not in reg_result_map.keys():
                        reg_result_map[reg_name]={
                                        'sdc': 0,
                                        'due': 0,
                                        'masked': 0,
                                        'total': 0,
...
if __name__=='__main__':
    if len(sys.argv) > 3:
        ...
        analyze_data(input_path='/home/mark/github/UFI2/out/IOV',output_path='/home/mark/github/UFI2/results/iov.log')
